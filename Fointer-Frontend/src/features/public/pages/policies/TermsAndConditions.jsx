    ...
    <div className="min-h-screen bg-[#110C08] text-[#E0D8D0] font-sans">
      ...
      <header className="bg-[#1A1A1A] border-b border-[#261E15] py-14 text-center relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <span className="inline-flex items-center gap-1.5 bg-[#D4AF37]/10 text-[#D4AF37] text-xs font-semibold tracking-wider uppercase px-3 py-1 rounded-full mb-4 border border-[#D4AF37]/30">
          ...
          <p className="mt-3 text-xs text-[#D4AF37]/70 font-mono">
          ...
          <aside className="lg:col-span-4">
            <div className="sticky top-8 bg-[#1A1A1A]/90 backdrop-blur-md p-5 rounded-xl border border-[#261E15] shadow-2xl">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#261E15]">
                <h2 className="text-xs font-bold text-[#D4AF37] uppercase tracking-widest font-mono">
                  Navigation Index
                </h2>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3.5 py-2.5 text-sm rounded-lg transition-all duration-200 flex items-center justify-between ${
                        isActive
                          ? 'bg-[#261E15] text-[#D4AF37] border-l-2 border-[#D4AF37] font-medium shadow-sm'
                          : 'text-gray-400 hover:bg-[#261E15]/50 hover:text-gray-200'
                      }`}
                    >
                      <span className="truncate">{item.title}</span>
                      {isActive && (
                        <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37] shrink-0 ml-2"></span>
                      )}
                    </button>
                  );
                })}
          ...
          <main className="lg:col-span-8 bg-[#1A1A1A]/60 p-6 sm:p-10 rounded-xl border border-[#261E15] space-y-12">
            ...
            <section id="acceptance" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">01</span>
                Acceptance of Terms
              </h2>
            ...
            <section id="conduct" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">02</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="p-4 bg-[#261E15]/60 border border-[#D4AF37]/20 rounded-lg">
                  <h3 className="font-semibold text-sm text-[#D4AF37] mb-1">No Harassment or Hate</h3>
                ...
                <div className="p-4 bg-[#261E15]/60 border border-[#D4AF37]/20 rounded-lg">
                  <h3 className="font-semibold text-sm text-[#D4AF37] mb-1">No Spam or Promotion</h3>
              ...
              <div className="p-4 bg-[#261E15] text-gray-300 rounded-lg border-l-2 border-[#D4AF37] text-xs sm:text-sm">
                <strong className="text-[#D4AF37] font-semibold">Moderation Enforcement:</strong> We reserve the right to edit, mute, or permanently delete posts and accounts that violate these core principles.
              </div>
            </section>
            ...
            <section id="accounts" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">03</span>
            ...
            <section id="content" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">04</span>
            ...
            <section id="intellectual" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">05</span>
            ...
            <section id="moderation" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">06</span>
            ...
            <section id="liability" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-serif text-white flex items-center gap-3 border-b border-[#261E15] pb-3 mb-4">
                <span className="text-[#D4AF37] font-mono text-sm font-bold">07</span>
            ...
            <section id="contact" className="scroll-mt-8 pt-2">
              <div className="bg-[#261E15] border border-[#D4AF37]/40 rounded-xl p-6 sm:p-8 text-center sm:text-left sm:flex sm:items-center sm:justify-between gap-6 shadow-xl">
                <div>
                ...
                {emailReady ? (
                  <a
                    ...
                    className="mt-4 sm:mt-0 inline-block bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-[#110C08] font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-lg transition-colors duration-200 shadow-md shrink-0"
                  >
                    Contact Support
                  </a>
                ) : (
