    ...
    <section className="bg-[#0E0C0A] text-white py-20 border-t border-amber-900/20 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center space-y-6">
        ...
        <h2 className="text-3xl sm:text-5xl font-serif text-amber-50 leading-tight">
          Join <span className="italic font-normal text-[#D4AF37]">Us</span>
        </h2>

        {/* Centered Circular Image (~40% width) */}
        <div className="w-[40%] max-w-[220px] aspect-square rounded-full p-1 border-2 border-[#D4AF37]/40 bg-[#0E0C0A] shadow-xl shadow-[#D4AF37]/10 relative group overflow-hidden my-2">
          <img 
        ...
        <div className="pt-2">
         <Link to="/contact-us">
         <button className="bg-[#D4AF37] hover:bg-[#e0c04a] text-[#0E0C0A] font-semibold text-xs sm:text-sm px-6 py-2.5 rounded-lg shadow-md shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/40 transition-all duration-300 hover:scale-105 active:scale-95">
            Get Started Today
          </button>
         </Link>
        </div>
