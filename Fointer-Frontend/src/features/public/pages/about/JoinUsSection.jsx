    ...
    <section className="bg-fo-bg text-fo-text py-20 border-t border-fo-border font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center space-y-6">
        ...
        <h2 className="text-3xl sm:text-5xl font-serif text-fo-text leading-tight">
          Join <span className="italic font-normal text-fo-accent">Us</span>
        </h2>

        {/* Centered Circular Image (~40% width) */}
        <div className="w-[40%] max-w-[220px] aspect-square rounded-full p-1 border-2 border-fo-accent/40 bg-fo-bg shadow-xl shadow-[#D4AF37]/10 relative group overflow-hidden my-2">
          <img 
        ...
        {/* Paragraph Text */}
        <p className="text-fo-muted text-sm sm:text-base font-light leading-relaxed max-w-2xl">
        ...
        <div className="pt-2">
         <Link to="/contact-us">
         <button className="bg-fo-accent hover:bg-fo-accent-hover text-fo-bg font-semibold text-xs sm:text-sm px-6 py-2.5 rounded-lg shadow-md shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/40 transition-all duration-300 hover:scale-105 active:scale-95">
            Get Started Today
          </button>
         </Link>
        </div>
