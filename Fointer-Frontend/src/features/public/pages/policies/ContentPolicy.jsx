      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto pt-8">
          <h1 className="text-4xl sm:text-6xl font-serif text-fo-text leading-tight">
            Fointer <span className="italic font-normal text-fo-accent">Content Policy</span>
          </h1>
          ...
          <div className="grid grid-cols-1 gap-6">
            {rules.map((rule, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="bg-fo-surface/90 border border-fo-accent/25 hover:border-fo-accent/50 rounded-3xl p-6 sm:p-8 backdrop-blur-md shadow-2xl transition-all duration-300 relative overflow-hidden"
                >
                  <div className="flex items-center gap-4 border-b border-fo-border pb-4 mb-4">
                    <div className="p-3 rounded-2xl bg-fo-accent/10 text-fo-accent border border-fo-accent/30 flex-shrink-0">
        ...
        <div className="bg-fo-surface/90 border border-fo-accent/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {enforcementPoints.map((point, pIdx) => (
              <div key={pIdx} className="bg-fo-bg/80 border border-fo-border rounded-xl p-4 text-xs sm:text-sm text-fo-muted font-light flex items-start gap-3">
          ...
          <p className="text-xs sm:text-sm text-fo-muted font-light leading-relaxed pt-4">
