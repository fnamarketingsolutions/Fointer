    ...
    <section className="bg-[#130D08] text-white py-24 border-t border-amber-900/20 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-300 text-sm sm:text-base font-light leading-relaxed">
            {/* Our Vision */}
            <div className="space-y-2">
          ...
          <div className="pt-8 border-t border-white/10 grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 font-light mt-1">Interactive Engagement</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-serif text-amber-50">100+</p>
              <p className="text-xs text-gray-400 font-light mt-1">Community Satisfaction</p>
            </div>
          </div>
        </motion.div>
