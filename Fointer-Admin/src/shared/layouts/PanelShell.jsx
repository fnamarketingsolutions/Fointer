...
/** Admin panel chrome: header + sidebar + mobile drawer (login-only, no signup). */
  ...
  return (
    <div className="min-h-screen bg-fo-bg text-fo-text font-sans flex flex-col antialiased selection:bg-fo-accent selection:text-black">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0 ml-auto">
          ...
          {isGuest ? (
            <Link
              ...
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-fo-border text-xs font-semibold text-fo-text hover:border-fo-accent/40 hover:text-fo-accent"
            >
              <LogIn size={14} /> Sign in
            </Link>
          ) : (
      ...
      <div className="flex-1 flex max-w-[1600px] w-full mx-auto relative">
        <aside className="w-64 border-r border-fo-border bg-fo-surface flex-col justify-between shrink-0 hidden md:flex max-h-[calc(100vh-5rem)] overflow-y-auto p-4">
          ...
          <div className="space-y-4 border-t border-fo-border pt-4 mt-4">
            <AuthFooter
              isGuest={isGuest}
