      ...
      <header className="flex items-start justify-between gap-3">
        <div className="space-y-1 min-w-0">
          ...
          <p className="text-sm text-[#8C8070]">
            Search, review, ban, or activate accounts.
          </p>
        </div>
        <button
          type="button"
        ...
        <div className="space-y-2.5">
          {users.map((u) => {
            ...
            return (
              <article
                key={u.id}
                className={`bg-[#14100D] border rounded-xl overflow-hidden transition-colors ${
                  expanded
                    ? "border-[#D4AF37]/40"
              ...
              >
                  ...
                  >
                    ...
                    <div className="min-w-0 space-y-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-[10px] uppercase tracking-wide text-[#8C8070]">
                          {u.role}
                        </span>
                        <span
                    ...
                    <span className="text-[#5C5348] shrink-0 hidden sm:block">
                      {expanded ? (
                        <ChevronUp size={16} />
                      ) : (
                        <ChevronDown size={16} />
                ...
                {expanded ? (
                  <div className="border-t border-[#2A241E] px-3.5 sm:px-4 py-4 space-y-4 bg-[#0E0C0A]/50">
                    {detailLoading ? (
                      ...
                      <>
                        <div className="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-[#8C8070]">
                          <span>
                            Name:{" "}
                          ...
                          {!detail.ownedCommunities?.length ? (
                            ...
                            detail.ownedCommunities.map((community) => {
                              ...
                              return (
                                <div
                                  key={community.id}
                                  className="border border-[#2A241E] rounded-xl bg-[#14100D] overflow-hidden"
                                >
                                  ...
                                  {membersOpen ? (
                                    <div className="border-t border-[#2A241E] px-3 py-3 space-y-2 bg-[#0E0C0A]/40">
                                        ...
                                        community.members.map((member) => (
                                          ...
                                          >
                                            <div className="min-w-0">
                                              <p className="text-[#E5E0D8] truncate">
                                                {member.user?.name ||
                                                  "Unnamed member"}
                                              </p>
                                              <p className="text-[11px] text-[#8C8070] truncate">
                                            ...
                                            <span className="text-[10px] uppercase tracking-wide text-[#8C8070] shrink-0">
                                              {member.role}
                                            </span>
                                          </div>
                                        ))
