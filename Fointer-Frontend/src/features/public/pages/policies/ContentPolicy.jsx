      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto pt-8">
          <h1 className="text-4xl sm:text-6xl font-serif text-amber-50 leading-tight">
            Fointer <span className="italic font-normal text-[#D4AF37]">Content Policy</span>
          </h1>
          ...
          <div className="grid grid-cols-1 gap-6">
            {rules.map((rule, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="bg-[#14100D]/90 border border-[#D4AF37]/25 hover:border-[#D4AF37]/50 rounded-3xl p-6 sm:p-8 backdrop-blur-md shadow-2xl transition-all duration-300 relative overflow-hidden"
                >
        ...
        <div className="bg-[#14100D]/90 border border-[#D4AF37]/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {enforcementPoints.map((point, pIdx) => (
              <div key={pIdx} className="bg-[#0E0C0A]/80 border border-white/10 rounded-xl p-4 text-xs sm:text-sm text-gray-300 font-light flex items-start gap-3">
