      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto pt-8">
          ...
          <h1 className="text-4xl sm:text-6xl font-serif text-fo-text leading-tight">
            Moderator <span className="italic font-normal text-fo-accent">Code of Conduct</span>
          </h1>
        ...
        <div className="bg-fo-surface/90 border border-fo-accent/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl relative overflow-hidden">
          <div className="flex items-center gap-4 border-b border-fo-border pb-6 mb-6">
            ...
            <div>
              <span className="text-xs font-mono tracking-widest text-fo-accent uppercase font-bold">Overview</span>
                ...
                >
                  <div className="flex items-center gap-4 border-b border-fo-border pb-6 mb-6">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl sm:text-3xl font-serif text-fo-text">
                        {rule.title}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {rule.points.map((pt, pIdx) => (
                      <div key={pIdx} className="bg-fo-bg/80 border border-fo-border rounded-xl p-4 text-xs sm:text-sm text-fo-muted font-light leading-relaxed flex items-start gap-3">
        ...
        <div className="bg-fo-surface/90 border border-fo-accent/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl space-y-6">
          <div className="flex items-center gap-4 border-b border-fo-border pb-6">
            ...
            <div>
              <span className="text-xs font-mono tracking-widest text-fo-accent uppercase font-bold">Compliance</span>
              <h2 className="text-2xl sm:text-3xl font-serif text-fo-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {enforcementActions.map((action, aIdx) => (
              <div key={aIdx} className="bg-fo-bg/80 border border-fo-border rounded-xl p-4 text-xs sm:text-sm text-fo-muted font-light flex items-start gap-3">
                <span className="text-fo-accent font-bold mt-0.5">•</span>
                <span>{action}</span>
              </div>
            ))}
        ...
        <div className="bg-fo-surface/90 border border-fo-accent/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl space-y-6">
          <div className="flex items-center gap-4 border-b border-fo-border pb-6">
            ...
            <div>
              <span className="text-xs font-mono tracking-widest text-fo-accent uppercase font-bold">Support</span>
              <h2 className="text-2xl sm:text-3xl font-serif text-fo-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {resources.map((res, rIdx) => (
              <div key={rIdx} className="bg-fo-bg/80 border border-fo-border rounded-2xl p-5 space-y-2">
                <h3 className="text-sm sm:text-base font-serif text-fo-accent font-semibold">
                  {res.title}
                </h3>
        ...
        <div className="bg-fo-surface/90 border border-fo-accent/30 rounded-3xl p-6 sm:p-10 backdrop-blur-md shadow-2xl space-y-6">
          <div className="flex items-center gap-4 border-b border-fo-border pb-6">
            ...
            <div>
              <span className="text-xs font-mono tracking-widest text-fo-accent uppercase font-bold">Inquiries</span>
              <h2 className="text-2xl sm:text-3xl font-serif text-fo-text">
                Contact & Support
              </h2>
            </div>
