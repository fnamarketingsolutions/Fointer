  ...
  return (
    <section className="bg-[#0E0C0A] text-white py-20 border-t border-amber-900/20 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-[#14100D] border border-[#D4AF37]/30 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl relative overflow-hidden text-center flex flex-col items-center space-y-8">
          ...
          <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#14100D]/90 via-[#14100D]/80 to-[#14100D]/95 pointer-events-none" />

          {/* Subtle Top Inner Glow inside Card */}
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#D4AF37]/15 rounded-full blur-3xl pointer-events-none z-0" />

          {/* Badge */}
          <span className="relative z-10 text-[11px] font-semibold tracking-[0.25em] text-[#D4AF37] uppercase px-4 py-1.5 rounded-full border border-[#D4AF37]/30 bg-[#0E0C0A]/80 inline-flex items-center gap-2 backdrop-blur-md">
          ...
          <div className="relative z-10 max-w-3xl space-y-4">
            <h2 className="text-3xl sm:text-5xl font-serif text-amber-50 leading-tight">
              Contact <span className="italic font-normal text-[#D4AF37]">Us</span>
            </h2>
          ...
          <div className="relative z-10 w-full max-w-md">
            <ActionTag
              {...actionProps}
              className="group flex items-center justify-between bg-[#0E0C0A]/90 hover:bg-[#24180f] border border-[#D4AF37]/40 hover:border-[#D4AF37] rounded-2xl p-4 sm:p-5 transition-all duration-300 shadow-lg hover:shadow-[#D4AF37]/10 backdrop-blur-sm"
            >
              <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
                <div className="p-2.5 rounded-xl bg-[#D4AF37]/10 text-[#D4AF37] border border-[#D4AF37]/20 group-hover:scale-105 transition-transform">
                ...
                <div className="text-left truncate">
                  ...
                  <p className="text-sm sm:text-base font-semibold text-white group-hover:text-[#D4AF37] transition-colors truncate">
                    {contactEmail || "Contact Us"}
                  </p>
                </div>
              </div>
              <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#D4AF37] group-hover:translate-x-1 transition-all flex-shrink-0 ml-2" />
            </ActionTag>
          </div>
